...
func (x *SimpleRequest) GetReqIdx() string {
	if x != nil {
		return x.ReqIdx
	}
	return ""
...
func (x *SimpleRequest) GetReqData() string {
	if x != nil {
		return x.ReqData
	}
	return ""
...
func (x *SimpleResponse) GetRspIdx() string {
	if x != nil {
		return x.RspIdx
	}
	return ""
...
func (x *SimpleResponse) GetRspData() string {
	if x != nil {
		return x.RspData
	}
	return ""
...
var file_simple_proto_rawDesc = []byte{
	...
	,
...
var file_simple_proto_depIdxs = []int32{
	0, // 0: proto.Simple.doRequest:input_type -> proto.SimpleRequest
	1, // 1: proto.Simple.doRequest:output_type -> proto.SimpleResponse
...
type SimpleClient interface {
	DoRequest(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
}
...
func (c *simpleClient) DoRequest(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/proto.Simple/doRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServer interface {
	DoRequest(context.Context, *SimpleRequest) (*SimpleResponse, error)
}
...
func (*UnimplementedSimpleServer) DoRequest(context.Context, *SimpleRequest) (*SimpleResponse, error) {
...
func _Simple_DoRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServer).DoRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Simple/DoRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).DoRequest(ctx, req.(*SimpleRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Simple_DoRequest_Handler,
		},
	},
